// ─────────────────────────────────────────────────────────────────────────────
// Module display info — Danish name + one-liner per module (PRD §9 catalog).
//
// Used by the admin ModuleEntitlementsPanel now and the "Udvid din BygSmart"
// marketplace in Phase 3. When a module is extracted its manifest carries the
// same name/description; this map is the fallback for modules that haven't
// registered a manifest yet.
// ─────────────────────────────────────────────────────────────────────────────
...
export interface ModuleInfo {
  name: string;
  description: string;
  /** PRD §7 grouping — drives marketplace/admin section headers. */
